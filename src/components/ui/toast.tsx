  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        "w-[350px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:slide-in-from-bottom-1 data-[state=closed]:slide-out-to-bottom-1",
        className
      )}
      {...props}
    />
